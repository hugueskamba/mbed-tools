...
def generate_mbed_config_cmake_file(
    mbed_target_name: str, target_build_attributes: dict, config: Config, toolchain_name: str, mbed_program: MbedProgram
) -> str:
    ...
    Args:
        ...
        mbed_program: The MbedProgram to configure.

    Returns:
        A string of rendered contents for the file.
    """
    return _render_mbed_config_cmake_template(
        target_build_attributes, config, toolchain_name, mbed_target_name, mbed_program,
    )


def _render_mbed_config_cmake_template(
    target_build_attributes: dict, config: Config, toolchain_name: str, target_name: str, mbed_program: MbedProgram
) -> str:
    ...
    context = {
        ...
        "mbed_os_path": mbed_program.mbed_os.root,
        "mbed_config_file": mbed_program.files.cmake_config_file,
    }
